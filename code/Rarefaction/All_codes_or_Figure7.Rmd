...
```{r}
geno_full_ori <- read.csv("final_data.csv") #3341 SNPs included after filtering
geno_ld_ori <- read.csv("rarefaction_LD_data.csv") # 6471 SNPs included without filtering by position 
...
```{r}
full_result_r_ori <- read.table("./adze_r.txt")
full_result_p_ori <- read.table("./adze_p.txt")
filtered_result_r_ori <- read.table("./adze_filtered_r.txt")
filtered_result_p_ori <- read.table("./adze_filtered_p.txt")

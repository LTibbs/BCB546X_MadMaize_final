...
```{r}
full_result_r_ori <- read.table("../../data//adze_r.txt")
full_result_p_ori <- read.table("../../data//adze_p.txt")
filtered_result_r_ori <- read.table("../../data/adze_filtered_r.txt")
filtered_result_p_ori <- read.table("../../data//adze_filtered_p.txt")
